...
const { ALL_RADIO_BANDS, RADIO_BAND_RULES, RADIO_COUNTRY_PROFILES } = radioRestrictionsData as RadioRestrictionsData

export const ALL_RADIO_BANDS_DATA = ALL_RADIO_BANDS
export const RADIO_BAND_RULES_DATA = RADIO_BAND_RULES
export const RADIO_COUNTRY_PROFILES_DATA = RADIO_COUNTRY_PROFILES
